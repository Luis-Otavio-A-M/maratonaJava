...
public class NormalizeTeste {
	public static void main(String[] args) {
		...
		/*
		 * O método normalize, como o nome sugere, normaliza o caminho,
		 * assim, interpretando o caminho final
		 */
		...
		String diretorioProjeto2 = "./home/./user/./dev";
		Path caminhoFinal2 = Paths.get(diretorioProjeto2);
		System.out.println(caminhoFinal2); //imprimi ./home/./user/./dev
		System.out.println(caminhoFinal2.normalize()); // imprime home/user/ev
	}
}
